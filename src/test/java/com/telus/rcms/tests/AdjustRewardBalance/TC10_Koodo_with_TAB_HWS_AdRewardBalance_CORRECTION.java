...
public class TC10_Koodo_with_TAB_HWS_AdRewardBalance_CORRECTION extends BaseTest {
	...
	public void testMethod_Activation(ITestContext iTestContext) throws Exception {
		...
		Map<String, Object> apiOperation3 = GenericUtils.featureFileFailLoop(environment,"classpath:tests/RCMS/AdjustRewardBalance/AdjustRewardBalanceTC10.feature","apiDetailsStatus" );
		Reporting.logReporter(Status.INFO,
